    ...
    <div className={classes.root}>
        ...
        <Toolbar   >
            ...
            <div  style={{
              ...
              >
                 ...
                 <ListItemIcon> 
                   <NotificationsActiveIcon fontSize='small'  style={{color:'white'}} />
                 </ListItemIcon>
                 <ListItemIcon> 
                   <FlagIcon  fontSize='small' style={{color:'white'}} />
                 </ListItemIcon>
                 <ListItemIcon style={{justifyContent:'center',alignItems:'center'}} > 
                    <Avatar style={{marginRight:10,width:30,height:30}} alt="Remy Sharp" src={avartar} />
                    <div >
                      <Typography    style={{textAlign:'center',color:'white'}} variant="caption" noWrap>
                        HR Name
                      </Typography>
                  </div>
                 </ListItemIcon>
      ...
      >
        <div className={classes.toolbar}>
          <div/>
          {open?<h3  style={{color:'white',textAlign:'center'}} >Admin</h3>:null}
